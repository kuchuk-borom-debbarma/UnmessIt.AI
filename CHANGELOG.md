...
### Added
- Added backend-driven Retrieval Analysis data with summary cards, nested flow steps, cache savings, skipped steps, LLM metrics, and context-packing savings.

### Fixed
- Retrieval progress publishing is now best-effort so Redis/SSE failures do not fail the retrieval query.
