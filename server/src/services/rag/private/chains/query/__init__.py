        ...
        try:
            ...
            data = await self.json_client.async_invoke_json(
                system=(
                    ...
                    "For appearance or physical-trait answers, preserve exact counts and descriptors such as moles, scars, marks, hair, eyes, height, and build when the snippets contain them. "
