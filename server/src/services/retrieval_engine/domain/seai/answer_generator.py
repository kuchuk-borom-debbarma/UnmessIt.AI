...
class StrictAnswerGenerator:
    ...
    def generate(self, query: str, context: str) -> CitedAnswer:
        system = (
            ...
            "Respect the question scope, including temporal words like early, current, recent, before, after, timeline, or over time. "
            "When several quotes support different parts of the answer, synthesize the complete supported picture instead of only the shortest match. "
            "If evidence is partial or conflicting, say so plainly. "
