...
AI processing settings and API rotation lanes are configured per user in the app Settings screen. Do not put provider keys or model endpoints in server runtime config.
